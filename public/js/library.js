...
var characteristics = (function(){
    ...
    c.init = function() {
        ...
        html += '<div class="widget textfield"><label for="char_val_'+index+'">Answer</label><input type="text" name="char_val_'+index+'" value="" />';
        html += '<div class="actions">';
        html += '<a href="#" class="delete">Delete</a>';
        html += '<a href="#" class="add">Add</a>';
        html += '</div>';
        html += '</div></div>';
        
        $('.char-set .add').bind('click', function() {
            return false;
        });
        
        $('.char-set .remove').bind('click', function() {
            return false;
        });
    };
